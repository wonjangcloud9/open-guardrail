...
**179개 가드. 26개 지역 PII. <0.1ms 지연. 벤더 종속 없음.**
...
![guards](https://img.shields.io/badge/가드-179-blue)
...
- **179개 가드** — 프롬프트 인젝션부터 GDPR 준수까지, 모두 패턴 기반 (ML 모델 불필요)
...
npx open-guardrail-cli list          # 179개 가드 조회
```
